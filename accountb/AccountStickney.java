...
public class AccountStickney{
	...
	AccountStickney(){//create an account with no variables initialized
	}
	
	AccountStickney(int newId, double newBalance){//create an account with a predefined id and balance
		id=newId;
		balance=newBalance;
	}
	...
	void setAnnualInterestRate(double newAnnualInterestRate){//set a new annual interest rate for this account
		AccountStickney.annualInterestRate = newAnnualInterestRate;
	}
