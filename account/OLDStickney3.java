	...
	public static void main(String[] args){
		...
		switch(input.nextInt()){//uses user input to determine whether the program will be automated or manually executed
			case 0://executes the test program automatically
				...
				Accountlastname test = new Accountlastname(testId, testBalance);//creates a new account using the test id(1122) and balance($20,000)
			...
			case 1://manual account creation
				...
				Accountlastname user = new Accountlastname();//creates a new uninitialized account
