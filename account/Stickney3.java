...
public class Stickney3{
	...
	Stickney3(){//create an account with no variables initialized
	}
	
	Stickney3(int newId, double newBalance){//create an account with a predefined id and balance
		id=newId;
		balance=newBalance;
	}
	...
	String getDateCreatedFormatted(){//return the date this account was created in mm/dd/yyyy format
		return dateFormat.format(dateCreated);
	}
	Date getDateCreated(){//returns the date this account was created
		return dateCreated;
	}
